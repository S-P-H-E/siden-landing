...
export default function Hero() {
    return (
        <div className="relative h-[100dvh] bg-white w-full flex flex-col items-center justify-center gap-5 rounded-t-3xl pt-24 z-10 mb-20">
            ...
            <h1 className="text-7xl font-bold w-[800px] text-center">Siden, your smart AI employee on demand.</h1>
            <p className="text-[var(--description)] font-medium">The most unfair advantage in business. Siden allows humans and AI to work together.</p>
